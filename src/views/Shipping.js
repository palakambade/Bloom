      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <ShippingPartner //showing different shipping partners option for the user to choose
                imageUri={require("../../assets/logo/logo_1.jpg")}
                name="DHL"
                description="No additional Costs"
              />
              <ShippingPartner
                imageUri={require("../../assets/logo/logo.jpg")}
                name="Blue Dart"
                description="No additional Costs"
              />
              <ShippingPartner
        ...
        >
          ...
          >
            <TouchableOpacity //navigate to payment page when clicked to "Next Step"
              activeOpacity={0.8}
