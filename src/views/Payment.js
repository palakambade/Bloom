    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <ShippingPartner //Different payment options showing paypal, credit card, debit card, GooglePay
                imageUri={require("../../assets/payment/payment_1.png")}
                name="Creditcard"
                description="Visa, Mastercard, DebitCard, CreditCard"
              />
              <ShippingPartner
              ...
              />
              <ShippingPartner
                imageUri={require("../../assets/payment/payment_3.jpg")}
                name="GooglePay"
                description="googlepay@gmail.com"
              />
            </View>
          </View>
        </View>
        ...
        >
          ...
          >
            <TouchableOpacity //touchable opacity to navigate through the credit card page 
              activeOpacity={0.8}
